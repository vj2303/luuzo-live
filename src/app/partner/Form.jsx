  ...
  return (
    <div className='mb-[100px] mt-6  max-w-[1200px] mx-auto'>
      ...
      <form onSubmit={handleSubmit(Submit)} className='mx-[22px] flex flex-col gap-[14px]'>
            ...
            {(field.type === 'text' || field.type === 'number') && (
              <div className="relative w-full">
                <input
                  ...
                  name={field.name}
                  placeholder={""}
                  className={`block p-[15px] w-full sm:w-[70%] text-base text-gray-900 bg-white border ${errors[field.name] ? 'border-red-500' : 'border-[#B9B9B9]border-[#B9B9B9]'} rounded-xl focus:border-blue-500 focus:ring-blue-500 focus:outline-none focus:ring-2 peer`}
                />
                <label
                  htmlFor={field.name}
        ...
        <button type="submit" className='bg-[#72B5EC] text-white font-semibold text-[16px] px-[50px] py-[15px] w-[70%] rounded-lg flex justify-center'>
          {
